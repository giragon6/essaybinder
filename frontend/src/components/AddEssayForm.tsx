...
export default function AddEssayForm({ newDocUrl, setNewDocUrl, addEssayByUrl, addingEssay }: AddEssayFormProps) {
  return (
    <div className="relative">
      <div className="relative p-6 bg-amber-200 border-2 max-w-md transform -rotate-1 sticky-note-shadow">
        
        <h3 className="text-xl font-bold mb-2 text-gray-700 text-center">
          add a new essay
        </h3>
        <p className="text-sm text-gray-500 text-center mb-4">
          (paste URL here, and then wait)
        </p>
        ...
        <div className="space-y-3">
          <input
            ...
            className="w-full p-3 text-gray-500 border-none outline-none focus:outline-none focus:ring-0 bg-transparent"
          />
          
          {/* Thumbtack button design */}
          <div className="flex items-center justify-center mt-6 relative">
            ...
            >
              ...
              {addingEssay && (
                <div className="absolute inset-0 flex items-center justify-center bg-amber-200 bg-opacity-80 rounded-full">
