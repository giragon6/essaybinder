  ...
  const checkCurrentUser = async () => {
    try {
      ...
      if (response.ok) {
        ...
        // Redirect to essays page if already logged in
        navigate('/essays');
      }
    } catch (error) {
            ...
            <div className="bg-white rounded-xl shadow-lg p-8">
              <div className="text-center">
                ...
                <p className="text-gray-600 mb-8">
                  Sign in to access your essay collection and manage your Google Docs catalog.
                </p>

                <button 
                  onClick={handleLogin}
                  disabled={signingIn}
                  className="w-full flex items-center justify-center px-6 py-3 border border-gray-300 rounded-lg shadow-sm bg-white text-gray-700 hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50 disabled:cursor-not-allowed transition-colors"
                >
                  {signingIn ? (
                    <>
                ...
                <div className="mt-6 text-center">
                  <p className="text-sm text-gray-500">
                    By signing in, you agree to our privacy-first approach.<br/>
          ...
          <div className="mt-8 bg-white rounded-xl shadow-lg p-6">
            ...
            <div className="space-y-3">
              <div className="flex items-center">
                ...
                <span className="text-gray-700">Organize Google Docs essays</span>
              </div>
              <div className="flex items-center">
                <svg className="h-5 w-5 text-green-500 mr-3" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
              ...
              <div className="flex items-center">
                ...
                <span className="text-gray-700">Metadata-only storage</span>
              </div>
            </div>
          </div>
        </div>
